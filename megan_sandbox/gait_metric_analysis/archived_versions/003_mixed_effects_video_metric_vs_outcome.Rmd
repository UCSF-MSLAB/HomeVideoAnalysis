...
# Notes and rationale 
Ran each metric through univariate models, using correlation differences for similar measures. For stance/swing/support metrics - selected for inclusion in multivar models based on highest R-squared for fixed effects in univariate models  
...
plot_outcome_transforms_vs_predictors <- function(df, outcome_cols, dataset_name, out_path){
  ...
  scatter_dir = file.path(output_dir, 'scatter', dataset_name)
...
all_univariate_mixed_effect <- function(data, outcome_column){ 
  ...
  print(formula1)
  uni1_log <- lmer(formula1, data = data)
  ...
  print(formula10)
  uni10 <- lmer(formula10, data = data)
  print(summary(uni10))
  ...
  uni10_df <- tidy(uni10, conf.int = TRUE) %>% 
    ...
    mutate(Variable = 'Stance Time - STD') 
  ...
  print(formula11)
  uni11 <- lmer(formula11, data = data)
  print(summary(uni11))
  ...
  uni11_df <- tidy(uni11, conf.int = TRUE) %>% 
    ...
    mutate(Variable = 'Swing Time - STD') 
  ...
  print(formula12)
  uni12 <- lmer(formula12, data = data)
  print(summary(uni12))
  ...
  print(formula13)
  uni13 <- lmer(formula13, data = data)
  print(summary(uni13))
  ...
  print(formula14)
  uni14 <- lmer(formula14, data = data)
  print(summary(uni14))
  ...
  uni14_df <- tidy(uni14, conf.int = TRUE) %>% 
    ...
    mutate(Variable = 'Single Support Time - STD') 
  
  # double support time - STD ------------------------
  ...
  print(formula15)
  uni15 <- lmer(formula15, data = data)
  print(summary(uni15))
  ...
  uni15_df <- tidy(uni15, conf.int = TRUE) %>% 
    ...
    mutate(Variable = 'Double Support Time - STD') 
  ...
  print(formula16)
  uni16 <- lmer(formula16, data = data)
  print(summary(uni16))
  ...
  print(formula17)
  uni17 <- lmer(formula17, data = data)
  print(summary(uni17))
  ...
  tidy_uni_df <- bind_rows(uni1_df, uni1_log_df, uni2_df, uni3_df, uni4_df, 
                           uni5_df, uni6_df, uni7_df,  
                           uni10_df, uni11_df, uni12_df, 
                           uni13_df, uni14_df, uni15_df, uni16_df,
                           uni17_df) %>% 
...
format_tables <- function(df){
  ...
  df <- df %>% 
    mutate(across(c('std.error', 'R2_conditional', 'R2_marginal'), \(x) round(x, digits = 2))) %>%
...
# maybe log T25FW? linear and more interpretable, less variance?
```

### Set outcome variable 
Need to run this chunk and all below for consistency 
```{r}
pws_t25fw_outcome_col = "t25fw_inverse"
```

### Functions - try 
```{r}
run_save_univariate <- function(df, outcome_column_str, data_name_string){
  ...
  # Plot estimates 
  plot_title <- paste(data_name_string, " Univariate - lmer(", 
                      outcome_column_str, 
                      "~ Predictor + (1 | bw_id))")
...
run_save_univariate(zeno_pws_df, pws_t25fw_outcome_col, 'PWS')
```
...
uni_zv_pws_t25fw_all <- all_univariate_mixed_effect(data = zeno_pws_df,
                                                    outcome_column = pws_t25fw_outcome_col) %>% 
  format_tables() %>% 
  mutate(Outcome = pws_t25fw_outcome_col)
write.csv(uni_zv_pws_t25fw_all, file.path(output_dir, 
                                          pws_t25fw_outcome_col,
                                          paste(pws_t25fw_outcome_col, '_univariate_pws_results.csv')))

# save adjusted r_squared 
adj_r_squared_df <- uni_zv_pws_t25fw_all[c('Variable', 'R2_conditional', 'R2_marginal')] %>% 
  distinct()  # remove duplicates 
print(adj_r_squared_df)
write.csv(adj_r_squared_df, file.path(output_dir,
                                      pws_t25fw_outcome_col,
                                      paste(pws_t25fw_outcome_col, 'univariate_pws_r2.csv')))

# Plot estimates 
plot_title <- paste("PWS Univariate - lmer(", 
                    pws_t25fw_outcome_col, 
                    "~ Predictor + (1 | bw_id))")

p <- univariate_regression_plot(results = uni_zv_pws_t25fw_all, 
                                plot_title = plot_title, 
                                x_adj = 0.1)
p 
ggsave(file.path(output_dir, 
                 pws_t25fw_outcome_col, 
                 paste(pws_t25fw_outcome_col, 'univariate_pws_estimates.png')), 
       bg = "white", width= 10, height=10)
...
t25fw_pws_multi_dem <- lmer(t25fw_pws_multi_dem_formula, 
                            data = zeno_pws_clean_df)
summary(t25fw_pws_multi_dem)

# Residuals vs. fitted values
plot(t25fw_pws_multi_dem, main = "Fitted vs Residuals: All Demographic and MS Info")
...
```{r}
t25fw_pws_multi_vid_unadj_formula <- as.formula(paste(pws_t25fw_outcome_col, 
...
t25fw_pws_multi_vid_unadj <- lmer(t25fw_pws_multi_vid_unadj_formula, 
                                  data = zeno_pws_clean_df)

summary(t25fw_pws_multi_vid_unadj)

# Residuals vs. fitted values
plot(t25fw_pws_multi_vid_unadj, main = "Residuals All Video Metrics Unadjusted")
...
t25fw_pws_multi_vid_adj <- lmer(t25fw_pws_multi_vid_adj_formula, 
                                data = zeno_pws_clean_df)

summary(t25fw_pws_multi_vid_adj)

# Residuals vs. fitted values
plot(t25fw_pws_multi_vid_adj, main = "Fitted vs Residuals: All Video Metrics Adjusted")
...
t25fw_pws_multivar_all <- bind_rows(t25fw_pws_multi_dem_df, 
                                    ...
                                    t25fw_pws_multi_vid_adj_df) %>% 
  format_tables()
write.csv(t25fw_pws_multivar_all, file.path(output_dir, 
                                            pws_t25fw_outcome_col,
                                            paste(pws_t25fw_outcome_col, 'adj_vs_unadj_pws_results.csv')))
...
write.csv(adj_r_squared_df, file.path(output_dir, 
                                      pws_t25fw_outcome_col,
                                      paste(pws_t25fw_outcome_col, 'adj_vs_unadj_pws_r2.csv')))
```
### Plot Unadjusted vs Adjusted Estimates 
```{r}
p <- adj_vs_unadj_plot(results_df = t25fw_pws_multivar_all, 
                       plot_title = paste("PWS: ", pws_t25fw_outcome_col), 
                       x_adj = 0.1)
p
ggsave(file.path(output_dir, 
                 pws_t25fw_outcome_col, 
                 paste(pws_t25fw_outcome_col, 'adj_vs_unadj_pws_estimates.png')),
...
```{r}
y_outcome_cols <- c("clean_T25FW_Avg", "t25fw_log", "t25fw_inverse", "t25fw_sqrt") 
plot_outcome_transforms_vs_predictors(zeno_fw_df, 'fw', output_dir)
# log? 
```
...
```{r}
uni_zv_fw_t25fw_all <- all_univariate_mixed_effect(data = zeno_fw_df,
                                                   outcome_column = fw_t25fw_outcome_col) %>% 
  format_tables() %>% 
  mutate(Outcome = fw_t25fw_outcome_col)
write.csv(uni_zv_fw_t25fw_all, file.path(output_dir, 
                                         fw_t25fw_outcome_col,
                                         paste(fw_t25fw_outcome_col, 'univariate_fw_results.csv')))
...
write.csv(adj_r_squared_df, file.path(output_dir, 
                                      fw_t25fw_outcome_col,
                                      paste(fw_t25fw_outcome_col,
                                            't25fw_inverse_univariate_fw_r2.csv'))
...
t25fw_fw_multivar_all <- bind_rows(t25fw_fw_multi_dem_df, 
                                   ...
                                   t25fw_fw_multi_vid_adj_df) %>% 
  format_tables()
write.csv(t25fw_fw_multivar_all, file.path(output_dir, 't25fw_inverse_adj_vs_unadj_fw_results.csv'))
...
```{r}
y_outcome_cols <- c("clean_T25FW_Avg", "t25fw_log", "t25fw_inverse", "t25fw_sqrt") 
plot_outcome_transforms_vs_predictors(home_df, 'home', output_dir)
```
...
uni_hv_t25fw_inv <- all_univariate_mixed_effect(data = home_df,
  ...
  format_tables()
write.csv(uni_hv_t25fw_inv, file.path(output_dir, 't25fw_inverse_univariate_home_results.csv'))
...
home_clean_df <- home_df %>% 
  drop_na(c("stride_time_median_sec_pose_hv", 
            ...
            "stance_time_sec_std_pose_hv", 
            "swing_time_sec_std_pose_hv"))

table(home_clean_df$race_ethnicity_clean)
```
...
t25fw_home_multi_vid_unadj <- lmer(t25fw_inverse ~ 
                                     ...
                                     mean_cadence_step_per_min_pose_hv + 
                                     stride_width_median_cm_pose_hv + 
                                     stance_time_per_mean_pose_hv + 
                                     tot_dsupport_time_sec_std_pose_hv +  
                                     (1|bw_id), 
                                   data = home_clean_df)
...
# Residuals vs. fitted values
plot(t25fw_home_multi_vid_unadj)
...
t25fw_home_multivar_all <- bind_rows(t25fw_home_multi_dem_df, 
                                     ...
                                     t25fw_home_multi_vid_adj_df) %>% 
  format_tables()
write.csv(t25fw_home_multivar_all, file.path(output_dir, 't25fw_inverse_adj_vs_unadj_home_results.csv'))
...
# sqrt
zeno_pws_df$sqrt_PWS_velocity <- sqrt(zeno_pws_df$PWS_velocitycmsecmean)

ggplot(data = zeno_pws_df, mapping = aes(sqrt_PWS_velocity)) + 
  geom_histogram()
```
...
# log 
home_df$log_FW_velocity <- log(home_df$FW_velocitycmsecmean)

ggplot(data = home_df, mapping = aes(log_FW_velocity)) + 
  geom_histogram()

# inverse  
home_df$inv_FW_velocity <- 1 / home_df$FW_velocitycmsecmean

ggplot(data = home_df, mapping = aes(inv_FW_velocity)) + 
  geom_histogram()

# square root 
home_df$sqrt_FW_velocity <- sqrt(home_df$FW_velocitycmsecmean)

ggplot(data = home_df, mapping = aes(sqrt_FW_velocity)) + 
  geom_histogram()
...
### Check outcome transforms and select metrics 
```{r}
y_outcome_cols <- c("PWS_velocitycmsecmean", "log_PWS_velocity", "inv_PWS_velocity", "sqrt_PWS_velocity") 
plot_outcome_transforms_vs_predictors(zeno_pws_df, y_outcome_cols, 'pws', output_dir)
...
uni_zv_pws_pwsvel <- all_univariate_mixed_effect(data = zeno_pws_df,
  ...
  format_tables()
write.csv(uni_zv_pws_pwsvel, file.path(output_dir, 'ZenoVelPws_univariate_pws_results.csv'))
...
# Residuals vs. fitted values
plot(pwsVel_pws_multi_dem, main = "Fitted vs Residuals All Demographic and MS Info")

# Normality check
qqnorm(residuals(pwsVel_pws_multi_dem), main = "Normal Q-Q plot: Residuals All Demographic and MS Info")
hist(residuals(pwsVel_pws_multi_dem), main = "Residuals All Demographic and MS Info")
...
# Residuals vs. fitted values
plot(pwsVel_pws_multi_vid_unadj, main = "Fitted vs Residuals: Residuals All Video Metrics Unadjusted")
...
# Residuals vs. fitted values
plot(pwsVel_pws_multi_vid_adj, main = "Fitted vs Residuals: All Video Metrics Adjusted")
...
pwsVel_pws_multivar_all <- bind_rows(pwsVel_pws_multi_dem_df, 
                                     ...
                                     pwsVel_pws_multi_vid_adj_df) %>% 
  format_tables()
write.csv(pwsVel_pws_multivar_all, file.path(output_dir, 'ZenoVelPws_adj_vs_unadj_pws_results.csv'))
...
### Check outcome transforms and select metrics 
```{r}
y_outcome_cols <- c("FW_velocitycmsecmean", "log_FW_velocity", "inv_FW_velocity", "sqrt_FW_velocity") 
...
uni_zv_fw_fwvel <- all_univariate_mixed_effect(data = zeno_fw_df,
  ...
  format_tables()
write.csv(uni_zv_fw_fwvel, file.path(output_dir, 'ZenoVelFw_univariate_fw_results.csv'))
...
# Residuals vs. fitted values
plot(fwVel_fw_multi_dem, main = "Fitted vs Residuals All Demographic and MS Info")
...
# Residuals vs. fitted values
plot(fwVel_fw_multi_vid_unadj, main = "Fitted vs Residuals All Video Metrics Unadjusted")
...
# Residuals vs. fitted values
plot(fwVel_fw_multi_vid_adj, main = "Fitted vs Residuals: All Video Metrics Adjusted")
...
fwVel_fw_multivar_all <- bind_rows(fwVel_fw_multi_dem_df, 
                                     ...
                                     fwVel_fw_multi_vid_adj_df) %>% 
  format_tables()
write.csv(fwVel_fw_multivar_all, file.path(output_dir, 'ZenoVelFw_adj_vs_unadj_fw_results.csv'))
...
uni_home_fwvel <- all_univariate_mixed_effect(data = home_df,
                                               outcome_column = "FW_velocitycmsecmean") %>% 
  format_tables()
write.csv(uni_home_fwvel, file.path(output_dir, 'ZenoVelFW_univariate_home_results.csv'))
...
# Residuals vs. fitted values
plot(fwVel_home_multi_vid_unadj)
...
fwVel_home_multivar_all <- bind_rows(fwVel_home_multi_dem_df, 
                                     ...
                                     fwVel_home_multi_vid_adj_df) %>% 
  format_tables()
write.csv(fwVel_home_multivar_all, file.path(output_dir, 'ZenoFW_adj_vs_unadj_home_results.csv'))
...
uni_home_pwsvel <- all_univariate_mixed_effect(data = home_df,
                                               outcome_column = "PWS_velocitycmsecmean") %>% 
  format_tables()
write.csv(uni_home_pwsvel, file.path(output_dir, 'ZenoVelPWS_univariate_home_results.csv'))
...
# Residuals vs. fitted values
plot(pwsVel_home_multi_vid_unadj)
...
# Residuals vs. fitted values
plot(pwsVel_home_multi_vid_adj)
...
pwsVel_home_multivar_all <- bind_rows(pwsVel_home_multi_dem_df, 
                                     ...
                                     pwsVel_home_multi_vid_adj_df) %>% 
  format_tables()
write.csv(pwsVel_home_multivar_all, file.path(output_dir, 'ZenoVelPWS_adj_vs_unadj_home_results.csv'))
