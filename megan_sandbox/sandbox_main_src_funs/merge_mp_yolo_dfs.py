...
def add_orientation_and_turn_direction(mp_pose_filepath, mp_all_df, yolo_df):

    mp_basename = os.path.basename(mp_pose_filepath)
    
    # add camera orientation from file name 
    if 'horizon' in mp_basename:
        mp_all_df['camera_orientation'] = 'horizontal'
        yolo_df['camera_orientation'] = 'horizontal'
    elif 'vert' in mp_basename: 
...
# save outputs 
def save_merge_mp_yolo_df(mp_pose_filepath, mp_all_df, yolo_filepath, yolo_df, output_parent_folder):
...
#[mp_all_df, yolo_df] = add_orientation_and_turn_direction(mp_pose_filepath, mp_all_df, yolo_df)
#save_merge_mp_yolo_df(mp_pose_filepath, mp_all_df, yolo_filepath, yolo_df, output_parent_folder)
